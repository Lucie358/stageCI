...
$routes->get('/admin/edit/(:num)', 'CompanyController::adminEdit/$1',['as' => 'adminEdit']);
$routes->post('/admin/update', 'CompanyController::adminUpdate',['as' => 'adminUpdate']);
$routes->get('/admin/add', 'CompanyController::showAdminAdd',['as' => 'showAdminAdd']);
$routes->get('/admin/remove/(:num)', 'CompanyController::adminRemove/$1',['as' => 'adminRemove']);
$routes->get('/internship/(:num)', 'CompanyController::internship/$1',['as' => 'internship']);
